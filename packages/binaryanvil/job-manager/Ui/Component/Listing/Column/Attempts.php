...
class Attempts extends Column
{
    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        foreach ($dataSource['data']['items'] as & $item) {
            if (!empty($item[Config::SCHEMA_JOB_FIELD_LAST_ERROR])) {
                $item[Config::SCHEMA_JOB_FIELD_ATTEMPTS] .=
                    '<i class="fa fa-exclamation-triangle has-errors" aria-hidden="true"></i>';
            }
        }
