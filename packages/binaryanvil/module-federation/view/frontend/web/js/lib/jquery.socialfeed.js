 ...
 *
 * If you use this plugin, please write us a short message https://gitter.im/pavelk2/social-feed
 * with a link to the project where you embed the plugin, and some features you want to have implemented here.
 * It helps us to stay focused on the important issues. It is not mandatory, but we really appreciate it!
 *
 * @license  MIT
 * @version  0.1.2
 * @category jQuery plugin
 * @resource http://kucherbaev.com
 * @resource https://github.com/pavelk2/social-feed
 * @resource https://pavelk2.github.io/social-feed-example/
 */
...
define(["jquery", "doT", "moment"], function ($, doT, moment, window, document, undefined) {
        ...
        var Feed = {
            ...
            init: function () {
                Feed.getTemplate(function () {
                    social_networks.forEach(function (network) {
                        if (options[network]) {
                            if (!options[network].cache_expired && options[network].cached_posts) {
                                options[network].cached_posts.forEach(function (cached_post) {
                                    if (cached_post.hasOwnProperty('identifier')) {
                                        cached_post['id'] = cached_post['identifier'];
                                    }
                                    if (cached_post.hasOwnProperty('created_time')) {
                                        cached_post['dt_create'] = moment(+cached_post['created_time']);
                                    }
                                    var post = new SocialFeedPost(network, cached_post);
                                    post.render();
                                });
                                return;
                            }
