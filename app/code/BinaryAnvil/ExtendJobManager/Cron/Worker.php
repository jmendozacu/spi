...
namespace BinaryAnvil\ExtendJobManager\Cron;
...
use BinaryAnvil\JobManager\Cron\Worker as OriginalWorker;

/**
 * Class Worker
 * @package BinaryAnvil\ExtendJobManager\Cron
...
class Worker extends OriginalWorker
{
     ...
     * @param JobRunResultInterface  $jobRunResult
